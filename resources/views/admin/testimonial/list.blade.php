                ...
                <th>Action</th>
                        ...
                        <tr>
                          ...
                          @endif
				            ...
				            <td>{{ucfirst($detail->publish==1? 'active':'inactive')}}</td>
				            <td>
				            	<a class="btn btn-info edit" href="{{route('testimonial.edit',$detail->id)}}" title="Edit">Edit</a>
				            	<form method= "post" action="{{route('testimonial.destroy',$detail->id)}}" class="delete">
                				{{csrf_field()}}
