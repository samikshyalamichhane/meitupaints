...
<div class="content">
	...
	@endif
<form method="post" action="{{route('dealer.update',$detail->id)}}" enctype="multipart/form-data">
	{{csrf_field()}}
		...
		<div class="col-md-8">
			<div class="box box-primary">
				<div class="box-header with-heading">
					<h3 class="box-title">Edit Dealers</h3>
				</div>
				<div class="box-body">
					...
					<div class="form-group">
						...
						<input type="number" name="phone" class="form-control" value="{{$detail->phone}}">
					</div>
